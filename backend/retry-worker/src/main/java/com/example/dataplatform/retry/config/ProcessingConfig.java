...
public class ProcessingConfig {
    ...
    @Bean
    public PaymentSchemaValidator paymentSchemaValidator(RetryWorkerProperties properties) {
    ...
    @Bean
    public S3DataLakeWriter s3DataLakeWriter(S3Client s3Client, RetryWorkerProperties properties) {
